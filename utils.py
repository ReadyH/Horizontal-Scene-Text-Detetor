...
def save_loss(loss, epoch, current_batch, loader, path='./log.txt'):

    with open(path, 'a') as f:
        line = 'Epoch: [{0}][{1}/{2}]\t Loss {4}\n'.format(epoch,current_batch, len(loader), loss)
        f.write(line)
